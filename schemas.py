...
class StatsSchema(Schema):
    ...
    field_goals = fields.Int()
    field_goal_attempts = fields.Int()
    field_goal_percentage = fields.Float()
    three_pointers = fields.Int()
    three_point_attempts = fields.Int()
    three_point_percentage = fields.Float()
    two_pointers = fields.Int()
    two_point_attempts = fields.Int()
    two_point_percentage = fields.Float()
    effective_field_goal_percentage = fields.Float()
    free_throws = fields.Int()
    free_throw_attempts = fields.Int()
    free_throw_percentage = fields.Float()
    offensive_rebounds = fields.Int()
    defensive_rebounds = fields.Int()
    total_rebounds = fields.Int()
    assists = fields.Int()
    steals = fields.Int()
    blocks = fields.Int()
    turnovers = fields.Int()
    personal_fouls = fields.Int()
    points = fields.Int()
