...
class Game(db.Model):
    ...
    local_team_stats = db.relationship("Stats", secondary="games_stats", back_populates="games_local", lazy="dynamic", single_parent=True, overlaps="visitor_team_stats")
    visitor_team_stats = db.relationship("Stats", secondary="games_stats", back_populates="games_visitor", lazy="dynamic", single_parent=True, overlaps="local_team_stats")
